...
public class JellyVertex
{
    ...
    public JellyVertex(int _verticeIndex, Vector3 _initialVertextPosition, Vector3 _currentVertexPosition, Vector3 _currentVelocity)
    {
        verticeIndex = _verticeIndex;
        initialVertexPosition = _initialVertextPosition;
